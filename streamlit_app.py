...
def Show_About_Us_Screen():
    st.title("About Us")
    st.markdown("""
        <div style="color: white;">
            <h4>Welcome to CALORIE BURN PREDICTOR — where smart tech meets your fitness goals!
        ...
        Stay sharp. Stay fit. Let’s do this together at CALORIE BURN PREDICTOR.</h4>
    """,unsafe_allow_html=True)
    st.rerun()
...
if st.session_state.logged_in:
    ...
    if st.session_state.forgot_password:
        ...
        Show_Sign_Up_Screen()
    elif st.session_state.about_us:
        Show_About_Us_Screen()
    else:
        Show_Login_Screen()
